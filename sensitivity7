...
afinal2 <- afinal1_psy %>% 
  mutate(DOB=as.Date(DOB),
         ...
         psyst=as.numeric(difftime(psyst, DOB, unit="days") +1),
         psyed=as.numeric(difftime(psyed, DOB, unit="days") +1),
...
formatdata1 <- formatdata(indiv=Reference.Key., astart=sdate, aend=edate1, aevent=admdt, 
                          adrug=list(Rxst0,Rxst1,Rxst2,psyst,c_i_under40_s,c_i_40to50_1_s,c_i_40to50_2_s,c_i_40to50_3_s,c_i_50to60_1_s,c_i_50to60_2_s,c_i_50to60_3_s,c_i_50to60_4_s,c_i_60to70_1_s,c_i_60to70_2_s,c_i_60to70_3_s,c_i_up70_s),
                          aedrug=list(Rxed0,Rxed1,Rxed2,psyed,c_i_under40_e,c_i_40to50_1_e,c_i_40to50_2_e,c_i_40to50_3_e,c_i_50to60_1_e,c_i_50to60_2_e,c_i_50to60_3_e,c_i_50to60_4_e,c_i_60to70_1_e,c_i_60to70_2_e,c_i_60to70_3_e,c_i_up70_e),
...
fmla <- paste(event~Rxst0+Rxst1+Rxst2+psyst+c_i_under40_s+c_i_40to50_s+c_i_50to60_s+c_i_60to70_s+c_i_up70_s+age+season, "+", "strata(indiv)", 
              "+", "offset(log(interval))")
